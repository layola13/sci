...
- Next portability order: execute and diagnose the macOS and Windows native workflows, then implement Darwin terminal winsize and native PTY raw-mode coverage. Harden POSIX process capture as an independent remaining risk before claiming arbitrary-size capture.
