...
- **Pending P0:** unified metrics (P0.1), remaining verify snapshot/source-map/differential/pressure contract (P0.2), final depfile/native-link key and cache concurrency contract (P0.3), request-local daemon paths/peer identity/bounded queue (P0.4), one shared reachability index (P0.5), remaining candidate-diff/cache telemetry explanation tooling (P0.6), provenance-complete baseline and 22-step rerun (P0.7), and backend A/B profiling (P0.8).
