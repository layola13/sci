...
test "cli build project cache is default and can be disabled" {
    ...
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"last_store_published_event_count\":1"));
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"last_store_failed_event_count\":0"));
...
test "cli cache status and why explain project cache entries" {
    ...
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 4, "last_store_published_event_count=null"));
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 4, "last_store_failed_event_count=null"));
    ...
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"last_store_published_event_count\":null"));
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"last_store_failed_event_count\":null"));
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"first_difference\":\"manifest.version\""));
    ...
    try writeBytes(tmp.dir, candidate_key_input_path,
        \\{"version":1,"kind":"build-exe","key_prefix":"bbbbbbbbbbbb","fields":[{"name":"schema","sha256":"1111111111111111111111111111111111111111111111111111111111111111"},{"name":"command","sha256":"4444444444444444444444444444444444444444444444444444444444444444"},{"name":"source_tree","sha256":"6666666666666666666666666666666666666666666666666666666666666666"}]}
        \\
    );
    stdout_buf.clearRetainingCapacity();
    stderr_buf.clearRetainingCapacity();
    const why_source_tree_candidate_code = try saasm.cli.executeWithWriters(std.testing.allocator, why_candidate_argv[0..], stdout_buf.writer(), stderr_buf.writer());
    try std.testing.expectEqual(@as(u8, 0), why_source_tree_candidate_code);
    try std.testing.expectEqual(@as(usize, 0), stderr_buf.items.len);
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"reason\":\"absent\""));
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"first_difference\":\"key.source_tree\""));
    try std.testing.expect(std.mem.indexOf(u8, stdout_buf.items, good_key) == null);
    try std.testing.expect(std.mem.indexOf(u8, stdout_buf.items, "5555555555555555555555555555555555555555555555555555555555555555") == null);
    try std.testing.expect(std.mem.indexOf(u8, stdout_buf.items, "6666666666666666666666666666666666666666666666666666666666666666") == null);
    ...
    try writeBytes(tmp.dir, candidate_key_input_path,
        \\{"version":1,"kind":"build-exe","key_prefix":"bbbbbbbbbbbb","fields":[{"name":"schema","sha256":"1111111111111111111111111111111111111111111111111111111111111111"},{"name":"command","sha256":"4444444444444444444444444444444444444444444444444444444444444444"},{"name":"semantic_file_inputs","sha256":"8888888888888888888888888888888888888888888888888888888888888888"},{"name":"source_tree","sha256":"5555555555555555555555555555555555555555555555555555555555555555"}]}
        \\
    );
    stdout_buf.clearRetainingCapacity();
    stderr_buf.clearRetainingCapacity();
    const why_semantic_file_candidate_code = try saasm.cli.executeWithWriters(std.testing.allocator, why_candidate_argv[0..], stdout_buf.writer(), stderr_buf.writer());
    try std.testing.expectEqual(@as(u8, 0), why_semantic_file_candidate_code);
    try std.testing.expectEqual(@as(usize, 0), stderr_buf.items.len);
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"reason\":\"absent\""));
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"first_difference\":\"key.semantic_file_inputs\""));
    try std.testing.expect(std.mem.indexOf(u8, stdout_buf.items, good_key) == null);
    ...
    stdout_buf.clearRetainingCapacity();
    stderr_buf.clearRetainingCapacity();
    const why_bad_candidate_sidecar_code = try saasm.cli.executeWithWriters(std.testing.allocator, why_candidate_argv[0..], stdout_buf.writer(), stderr_buf.writer());
    try std.testing.expectEqual(@as(u8, 0), why_bad_candidate_sidecar_code);
    try std.testing.expectEqual(@as(usize, 0), stderr_buf.items.len);
    try std.testing.expect(std.mem.containsAtLeast(u8, stdout_buf.items, 1, "\"reason\":\"absent\""));
