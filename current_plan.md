...
- Source/facade/test changes are complete for the Vec copy alias batch.
...
- Commit the Vec copy alias batch, then continue the highest-priority String/Vec Rust API parity audit.
