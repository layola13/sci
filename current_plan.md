...
5. [ ] **Partial — P0.6 cache explanation surface:**
   ...
   - [ ] finish true candidate old-entry key first-difference reporting, richer write-event audit telemetry beyond successful-publish result, redaction review, and broader cross-process/cross-platform coverage.
