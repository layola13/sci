...
- Source/facade/test changes are complete for the Vec chunk/window access alias batch.
...
- Commit the Vec chunk/window access alias batch, then continue the highest-priority String/Vec Rust API parity audit.
