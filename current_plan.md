...
- Source/facade/test changes are complete for the Vec unchecked split/range alias batch.
...
- Commit the Vec unchecked split/range alias batch, then continue the highest-priority String/Vec Rust API parity audit.
