...
5. [ ] **Partial — P0.6 cache explanation surface:**
   ...
   - [ ] finish fine-grained candidate old-entry key input first-difference reporting beyond coarse `key.digest`, richer write-event audit telemetry beyond coarse result/stage fields, redaction review, and broader cross-process/cross-platform coverage.
