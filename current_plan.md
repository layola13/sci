...
- Source/facade/test changes are complete for the Vec first_mut/last_mut alias batch.
...
- Commit the Vec first_mut/last_mut alias batch, then continue the highest-priority String/Vec Rust API parity audit.
