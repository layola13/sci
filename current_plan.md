...
- Source/facade/test changes are complete for the Vec unchecked alias batch.
...
- Commit the Vec unchecked alias batch, then continue the highest-priority String/Vec Rust API parity audit.
