...
- This batch does not model env maps, pipe Stdio redirection wiring, full heap `Command` objects, chroot builder wrappers, or capture-time CommandExt groups integration.
...
- This batch does not model env maps, pipe Stdio redirection wiring, full heap `Command` objects, chroot builder wrappers, or capture-time CommandExt uid/gid integration.
